...
def build_standard():
    ...
    story=[]
    story += title_block('Standard 0.1','Kriterien für physische Produkte, deren wesentliche Herstellungsschritte nachweislich durch Menschen ausgeführt werden.','MBH-STD-0.1','Version 0.1',[
    ...
    doc.build(story,onFirstPage=lambda c,d: header_footer(c,d,'MBH-STD-0.1','Standard','Version 0.1'),onLaterPages=lambda c,d: header_footer(c,d,'MBH-STD-0.1','Standard','Version 0.1'))
...
def build_scheme():
    ...
    story=[]
    story += title_block('Zertifizierungsschema 0.1','Regelwerk für Rollen, Prüfprozess, Zertifizierungsentscheidung, Statusverwaltung, Register und Markennutzung.','MBH-SCH-0.1','Version 0.1',[
