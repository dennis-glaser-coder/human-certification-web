...
def build_scheme():
    ...
    story=[]
    story += title_block('Zertifizierungsschema 0.1','Arbeitsfassung für Rollen, Prüfprozess, Zertifizierungsentscheidung, Statusverwaltung, Register und Markennutzung.','MBH-SCH-0.1','Arbeitsfassung - Zielstruktur in Validierung',[
    ...
    story += [P('1  Zweck und Status','h1'),P('Dieses Dokument beschreibt die vorgesehene Funktionsweise des Made by Humans Zertifizierungssystems getrennt vom eigentlichen Produktstandard.'),P('Es regelt nicht, welche Produkteigenschaft erfüllt sein muss - das ist Aufgabe des Arbeitsstandards. Es beschreibt, wie Antrag, Prüfung, fachliche Kontrolle, Entscheidung, Register, Statusänderungen und Markennutzung strukturiert werden sollen.'),P('Version 0.1 ist eine Zielstruktur. Rechtliche und organisatorische Verantwortlichkeiten werden vor dem öffentlichen kommerziellen Start final festgelegt.'),P('2  Rollen im System','h1')]
    ...
    story += [callout('Wichtiger Statushinweis','Die konkrete organisatorische Trennung und rechtliche Verantwortlichkeit dieser Rollen ist noch nicht final festgelegt. Es wird derzeit keine Unabhängigkeit oder Akkreditierung behauptet.'),Spacer(1,4*mm),P('3  Antrag und Zertifizierungsumfang','h1')]
    for x in ['Antragsteller benennt Unternehmen, Produkt oder Produktfamilie und relevante Herstellungsorte.','Der Zertifizierungsumfang wird so abgegrenzt, dass klar ist, welche Produkte, Varianten und Produktionsprozesse erfasst sind.','Wesentliche Fremdfertigung und relevante Zulieferprozesse werden in den Zertifizierungsumfang aufgenommen, soweit sie für die zertifizierte Eigenschaft erforderlich sind.','Vor der Prüfung wird geklärt, welche Standardversion anzuwenden ist.']:
        story.append(bullet(x))
