...
def build_standard():
    ...
    story += [P('2  Geltungsbereich','h1'),P('Bewertet wird ein definiertes physisches Produkt oder eine klar abgegrenzte Produktfamilie und der zugehörige Herstellungsprozess.'),P('Der Standard ist branchenübergreifend angelegt. Entscheidend ist nicht die Produktkategorie, sondern ob ein physisches Produkt und seine wesentlichen Herstellungsschritte eindeutig abgegrenzt und nachweisbar geprüft werden können.'),P('2.1  Nicht Gegenstand dieser Fassung','h2')]
