...
def build_standard():
    ...
    story=[]
    story += title_block('Arbeitsstandard 0.1','Kriterien für physische Produkte, deren wesentliche Herstellungsschritte nachweislich durch Menschen ausgeführt werden.','MBH-STD-0.1','Version 0.1',[
    ...
    story += [P('2  Geltungsbereich','h1'),P('Bewertet wird ein definiertes physisches Produkt oder eine klar abgegrenzte Produktfamilie und der zugehörige Herstellungsprozess.'),P('Der Standard ist branchenübergreifend angelegt. Der Geltungsbereich umfasst insbesondere Lederwaren, Schmuck, Möbel und Holzprodukte, Keramik und Glas, Mode und Textil sowie Wohnaccessoires im Fokus.'),P('2.1  Nicht Gegenstand dieser Fassung','h2')]
    ...
    doc.build(story,onFirstPage=lambda c,d: header_footer(c,d,'MBH-STD-0.1','Arbeitsstandard','Version 0.1'),onLaterPages=lambda c,d: header_footer(c,d,'MBH-STD-0.1','Arbeitsstandard','Version 0.1'))
...
def build_scheme():
    ...
    doc.build(story,onFirstPage=lambda c,d: header_footer(c,d,'MBH-SCH-0.1','Zertifizierungsschema','Version 0.1'),onLaterPages=lambda c,d: header_footer(c,d,'MBH-SCH-0.1','Zertifizierungsschema','Version 0.1'))
