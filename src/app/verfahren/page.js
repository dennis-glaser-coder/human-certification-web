...
export default function ProceduresPage() {
  return (
    <main className="procedureInstitution">
      ...
      <section className="procedureIntegrity"><div className="shell procedureIntegrityGrid"><div><div className="sectionNo light">INTERESSENKONFLIKTE</div><h2>Zuständigkeiten müssen nachvollziehbar bleiben.</h2></div><div><p>Mögliche wirtschaftliche, personelle oder gesellschaftsrechtliche Verbindungen werden im jeweiligen Vorgang dokumentiert. Bei Einsprüchen wird die angefochtene Entscheidung nicht ausschließlich durch dieselbe Person abschließend überprüft, die sie ursprünglich getroffen hat. Von Akkreditierung oder externer Unabhängigkeit sprechen wir nur, wenn diese Eigenschaft tatsächlich besteht und belegt werden kann.</p></div></div></section>
